...
const INSIGHTS = [
  ...
  {
    title: 'Most Affordable Concert Cities 2026',
    description: 'Where can you see the most live music for the least money? Cities ranked by average starting ticket price.',
    href: '/insights/affordable-concert-cities',
    icon: (
      <svg className="w-8 h-8 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
